...
VALUES ('NV01', 'Nguyen Van A', '123456789', '1990-01-01', 'Nam', '123 Đường ABC', '0123456789', 1000000, 500000, 'Phong A', 1.2),
       ('NV02', 'Tran Thi B', '987654321', '1995-05-05', 'Nu', '456 Đường XYZ', '0987654321', 1200000, 600000, 'Phong B', 1.3);
...
VALUES ('CCNV01', 'NV01', '2024-04-01', 'Ca sang', '8h-12h', 200000, 'Da cham cong', 'Khong nghi phep'),
       ('CCNV02', 'NV02', '2024-04-01', 'Ca chieu', '13h-17h', 250000, 'Da cham cong', 'Nghi phep');
...
VALUES ('CCCN01', 'Ca sang', '8h-12h', 300000, '2024-04-05', 'Khong nghi phep', 80, 'Cong doan 1', 'Nguyen Van C', 'Da cham cong', 'CN01', 'CD01', 'PC01'),
       ('CCCN02', 'Ca chieu', '13h-17h', 250000, '2024-04-06', 'Nghi phep', 70, 'Cong doan 2', 'Tran Thi D', 'Chua cham cong', 'CN02', 'CD02', 'PC02');
...
VALUES 
    ('LCN01', 2024, 4, 22, 'Nguyen Van A', 5000000, 'CN01'),
    ('LCN02', 2024, 4, 20, 'Tran Thi B', 4500000, 'CN02');
...
VALUES 
    ('LNV01', 2024, 4, 22, 'Nguyen Van A', 7000000, 'NV01'),
    ('LNV02', 2024, 4, 20, 'Tran Thi B', 6500000, 'NV02');
